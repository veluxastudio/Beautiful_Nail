    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-[#ff2056] to-rose-400
        ...
        <div className="relative z-10 text-center text-white space-y-6 max-w-sm">
          ...
          <div>
            <h1 className="text-4xl font-bold">Nyonya Kuku</h1>
      ...
      <div className="flex-1 flex items-center justify-center bg-gray-50 p-6">
        <div className="w-full max-w-md">
          ...
          <div className="flex items-center gap-3 mb-8 lg:hidden">
            ...
            <div>
              <p className="font-bold text-base leading-tight">Nyonya Kuku</p>
          ...
          <p className="text-center text-xs text-gray-400 mt-6">
            © {new Date().getFullYear()} Nyonya Kuku. All rights reserved.
          </p>
        </div>
      </div>
    </div>
